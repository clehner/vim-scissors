...
var httpListenPort = process.env.HTTP_PORT || 3220;
var httpListenHost = process.env.HTTP_HOST || '0.0.0.0';
...
console.log('Starting vim-scissors on ' + listenHost + ':' + listenPort + ', ' +
	'with HTTP on ' + httpListenHost + ':' + httpListenPort + '.');
nbServer.on('clientAuthed', onClientConnect);
nbServer.listen(listenPort, listenHost);
httpServer.listen(httpListenPort, httpListenHost);
