...
Style.prototype.diff = objPool(Object, function(diff, other) {
	var dirty,
		prop,
		from = this.style,
...
Rule.prototype.diff = objPool(Object, function(diff, other) {
	var dirty;
...
KeyframesRule.prototype.diff = objPool(Object, function(diff, other) {
	var dirty;
...
Keyframes.prototype.diff = objPool(Object, function(diff, other) {
	var dirty;
...
Keyframe.prototype.diff = objPool(Object, function(diff, other) {
	var dirty;
	if (!other) {
		return this.toJSON();
	}
...
MediaRule.prototype.diff = objPool(Object, function(diff, other) {
	var dirty;
...
RulesList.prototype.diff = objPool(Array, function(rulesDiff, other) {
	var skip = 0,
